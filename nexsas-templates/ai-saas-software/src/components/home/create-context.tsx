...
const CreateContext = () => {
  ...
  return (
    <div className="h-[404px] rounded-xl bg-white/30 p-2 backdrop-blur-[30px]">
        ...
        <div className="bg-background-6 border-stroke-3/11 relative overflow-hidden rounded-xl border p-2">
          ...
          <div className="relative z-10">
            <input
              ...
              className="placeholder:text-tagline-3 text-tagline-3 font-inter-tight w-full rounded-lg border border-white/3 bg-white/5 px-4 py-[11px] font-normal text-white backdrop-blur-[32px] placeholder:text-white/60 focus:ring-1 focus:ring-white/10 focus:outline-none"
            />
