  ...
  return (
    <div className="min-h-[404px] rounded-xl bg-white/30 p-2 backdrop-blur-[30px]">
      <div className="bg-background-7 flex h-full flex-col justify-between space-y-8 rounded-lg p-7 md:p-10.5">
        <div className="font-instrument-serif text-is-heading-4 text-black">1</div>

        <div ref={containerRef} className="relative z-0 flex items-end justify-center -space-x-4">
          <figure
            ref={img1Ref}
            className="h-full max-h-24.5 w-full max-w-20.5 overflow-hidden rounded-[4px]"
          >
            <Image src={opaiImg31} alt="Template 1" className="size-full object-cover" />
          </figure>
          ...
          <figure
            ...
            className="h-full max-h-24.5 w-full max-w-20.5 overflow-hidden rounded-[4px]"
          >
            <Image src={opaiImg32} alt="Template 2" className="size-full object-cover" />
          </figure>

          <figure
            ref={img3Ref}
            className="relative z-10 h-full max-h-24.5 w-full max-w-20.5 overflow-hidden rounded-[4px]"
          >
            <Image src={opaiImg33} alt="Template 3" className="size-full object-cover" />
          </figure>
          ...
          <figure
            ...
            className="h-full max-h-24.5 w-full max-w-20.5 overflow-hidden rounded-[4px]"
          >
            <Image src={opaiImg34} alt="Template 4" className="size-full object-cover" />
          </figure>
        </div>
