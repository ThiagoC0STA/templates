...
interface LinkButtonProps extends Omit<React.ComponentPropsWithoutRef<typeof Link>, 'href' | 'children' | 'className'> {
  className?: string;
  href: string;
...
const LinkButton = ({ className, href, children, ariaLabel, ...linkProps }: LinkButtonProps) => {
