'use client';
import { ContactIcon, CustomersIcon, ServiceIcon, TestimonialIcon } from '@/icons/menu-icon';
...
const EngageMenu = ({
  ...
  return (
    <div>
      <div
        className={cn(
          'pointer-events-none absolute top-full left-1/2 z-40 h-3 w-full min-w-[300px] -translate-x-1/2 bg-transparent opacity-0',
