...
const suggestedBeats = MOCK_BEATS.filter(
  (beat) => !cartItems.some((item) => item.beat.id === beat.id),
).slice(0, 4);
...
export function MusicTemplateV1Cart({ selection }: { selection: TemplateSelection }) {
        ...
        <div className="space-y-6">
          ...
          <Card className="border-border/50 bg-background/80">
            <CardHeader>
              ...
              <CardDescription>
                Drop instructions for mix tweaks, tags, or shout-outs you want in the files.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <textarea
        ...
        <aside className="space-y-6">
          <Card className="border-border/50 bg-background/70">
            <CardHeader>
              ...
              <CardDescription>
                Continue the vibe with curated picks based on your current cart.
              </CardDescription>
            </CardHeader>
              ...
              <ScrollArea className="h-64">
                <div className="space-y-4 px-6">
                  {suggestedBeats.map((beat) => (
                    <div
                      key={beat.id}
                      className="flex items-center justify-between gap-4 rounded-2xl border border-border/30 bg-muted/20 p-4"
                    >
                      ...
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="border-purple-400/40 text-purple-400 hover:bg-purple-500/10"
                      >
                        <Link href={buildTemplatePath(selection, `/booth/${beat.id}`)}>Preview</Link>
                      </Button>
                    </div>
                  ))}
                </div>
          ...
          <Card className="sticky top-24 border-border/50 bg-background/80 backdrop-blur">
            <CardHeader className="border-b border-border/30 pb-5">
              ...
              <CardDescription>
                You are minutes away from getting the untagged files in your inbox.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 py-5">
              ...
              <Button variant="outline" className="w-full" size="lg" asChild>
                <Link href={buildTemplatePath(selection, "/results")}>Keep browsing</Link>
              </Button>
            </CardContent>
